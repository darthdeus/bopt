...
def main():
    ...
    model_parser.add_argument("--kernel", type=str, default="rbf", help=f"Specifies the GP kernel. Allowed values are: {kernel_names}")
    model_parser.add_argument("--acquisition_fn", type=str, default="ei", help=f"Specifies the acquisition function. Allowed values are: {acq_fn_names}")
    ...
    sp_run = sp.add_parser("run", help="Runs an experiment.", parents=[cd_parser, model_parser])
